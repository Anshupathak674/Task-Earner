        ...
        <div class="row">
            ...
            <div class="col-7 align-self-center">
                <div class="d-flex no-block justify-content-end align-items-center">
                    ...
                    <?php $i = 0;
                    foreach ($fetch_user_details as $category) {

                        $i++;
                    } ?>
                    <div class=""><small>Total Users</small>
                                        ...
                                        foreach ($fetch_user_details as $category) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                       ...
                                                       <b> <?php echo $category->user_name; ?></b>
                                                   
                                                </td>
                                                <td>
                                                    
                                                 <b>   <?php echo $category->user_email; ?></b>
                                               
                                            </td>
                                            <td>
                                                    
                                                    <?php echo $category->user_password; ?>
                                               
                                            </td>
                                                <td>
                                                    <b>

                                                        <?php echo $category->user_date; ?>
