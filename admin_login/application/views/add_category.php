                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            ?>
                                ...
                                <form class="form" action="<?= base_url() ?>index.php/category_check" method="POST" >
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="text-muted"><i class="fa fa-clock-o"></i><?php echo $category->category_date; ?></span> </td>


                                            <td class="actions">
                                                <a class="remove" href="<?php echo base_url(); ?>index.php/delete_category?category_id=<?php echo $category->category_id; ?>" ><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                            } else {  ?>
