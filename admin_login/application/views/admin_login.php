            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium mb-3" style="padding-top: 15px;">Hire A Freelancer </h5>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3" action="<?= base_url() ?>login_check" method="POST" >
                                ...
                                <div class="form-group mb-0 mt-2">
                                    <div class="col-sm-12 text-center">
                                        Don't have an account? <a href="<?= base_url() ?>tasker_registration" class="text-info ml-1"><b>Sign Up</b></a>
                                    </div>
                                </div>
